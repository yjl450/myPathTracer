...
public:
	...
	Sphere(Eigen::Vector3d center, double radius, Eigen::Vector3d amb, Material material, Eigen::Transform<double, 3, Eigen::Affine> transformation, bool trans_flag);
...
public:
	...
	Triangle(Eigen::Vector3d vertex0, Eigen::Vector3d vertex1, Eigen::Vector3d vertex2, Eigen::Transform<double, 3, Eigen::Affine > transformation, Eigen::Vector3d amb, Material material);
...
public:
	...
	TriNormal(Eigen::Vector3d vertex0, Eigen::Vector3d vertex1, Eigen::Vector3d vertex2, Eigen::Transform<double, 3, Eigen::Affine > transformation, Eigen::Vector3d amb, Material material) :Triangle(vertex0, vertex1, vertex2, transformation, amb, material) {
	};
